...
func TestRegister(t *testing.T) {
	...
	_, err = identityManager.Register(&msp.RegistrationRequest{})
	if err == nil {
	...
	secret, err := identityManager.Register(&msp.RegistrationRequest{Name: "test", Affiliation: "test", Attributes: attributes})
	if err != nil {
...
func TestEmbeddedRegister(t *testing.T) {
	...
	attributes = append(attributes, msp.Attribute{Key: "test1", Value: "test2"})
	attributes = append(attributes, msp.Attribute{Key: "test2", Value: "test3"})
	secret, err := identityManager.Register(&msp.RegistrationRequest{Name: "withEmbeddedRegistrar", Affiliation: "test", Attributes: attributes})
	if err != nil {
		t.Fatalf("identityManager Register return error %v", err)
	}
	if secret != "mockSecretValue" {
...
func TestRegisterNoRegistrar(t *testing.T) {
	...
	attributes = append(attributes, msp.Attribute{Key: "test1", Value: "test2"})
	attributes = append(attributes, msp.Attribute{Key: "test2", Value: "test3"})
	_, err = identityManager.Register(&msp.RegistrationRequest{Name: "test", Affiliation: "test", Attributes: attributes})
	if err != core.ErrCARegistrarNotFound {
		t.Fatalf("Expected ErrCARegistrarNotFound, got: %v", err)
	}
}
...
func TestRevoke(t *testing.T) {
	...
	_, err = identityManager.Revoke(&msp.RevocationRequest{})
	if err == nil {
