...
func TestInstantiateCCWithDifferentMSP(t *testing.T) {
	...
	req := InstantiateCCRequest{Name: "name", Version: "version", Lang: "golang", Path: "path", Policy: ccPolicy}
...
func TestUpgradeCCWithDifferentMSP(t *testing.T) {
	...
	// Valid request
	ccPolicy := cauthdsl.SignedByMspMember("otherMSP")
	req := UpgradeCCRequest{Name: "name", Version: "version", Lang: "golang", Path: "path", Policy: ccPolicy}
...
func TestCCProposal(t *testing.T) {
	...
	ccPolicy := cauthdsl.SignedByMspMember("Org1MSP")
	instantiateReq := InstantiateCCRequest{Name: "name", Version: "version", Lang: "golang", Path: "path", Policy: ccPolicy}
