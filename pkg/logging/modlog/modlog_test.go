...
func testDefaultLogging(t *testing.T) {
	...
	utils.VerifyTrue(t, api.INFO == GetLevel(moduleName), " default log level is INFO")
	...
	*/
	...
	//Should be false
	utils.VerifyFalse(t, IsEnabledFor(moduleName, api.DEBUG), "apiapilogging.IsEnabled for is not working as expected, expected false but got true")

	//Now change the log level to apilogging.DEBUG
	SetLevel(moduleName, api.DEBUG)

	//Should be false
	utils.VerifyTrue(t, IsEnabledFor(moduleName, api.DEBUG), "apiapilogging.IsEnabled for is not working as expected, expected true but got false")
...
func TestDefaultCustomModulledLogging(t *testing.T) {
	...
	//No level set for this module so log level should be info
	utils.VerifyTrue(t, api.INFO == GetLevel(moduleName2), " default log level is INFO")
	...
	//Should be false
	utils.VerifyFalse(t, IsEnabledFor(moduleName2, api.DEBUG), "logging.IsEnabled for is not working as expected, expected false but got true")

	//Now change the log level to DEBUG
	SetLevel(moduleName2, api.DEBUG)

	//Should be false
	utils.VerifyTrue(t, IsEnabledFor(moduleName2, api.DEBUG), "logging.IsEnabled for is not working as expected, expected true but got false")
